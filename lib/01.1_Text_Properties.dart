  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      body: Align(
        ...
        child: Text(
              "my name is pratham patel fhfisahfhafofsfdfsfatf7astffhifg8aohigaukgy", // string which using for disply textin screen and also this string is positional parameter
